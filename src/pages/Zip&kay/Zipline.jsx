    ...
    <div className="w-full bg-gradient-to-r from-[#fafafa] to-[#FFF5E4] josefin-sans">
      ...
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto space-y-24">
          {/* Zipline / Paragliding */}
          <div className="text-left w-full md:w-[70%] opacity-0 animate-fade-left">
          ...
          <div className="text-right w-full md:w-[70%] ml-auto opacity-0 animate-fade-right [animation-delay:0.2s]">
            <p className="text-gray-800 text-lg md:text-xl leading-relaxed font-medium">
          ...
          <div className="text-left w-full md:w-[70%] opacity-0 animate-fade-left [animation-delay:0.4s]">
            <p className="text-gray-800 text-lg md:text-xl leading-relaxed font-medium">
