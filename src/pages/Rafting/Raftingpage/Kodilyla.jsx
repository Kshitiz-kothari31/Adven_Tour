    ...
    <section className='josefin-sans bg-gradient-to-b from-[#dff6ff] via-[#b7e4f4] to-[#dff6ff]' >
      ...
      <div className="relative w-full h-[90vh] overflow-hidden font-josefin">
        ...
        <div className="absolute top-[30%] right-10 md:right-20 text-right z-40 opacity-0 animate-fadeInRight">
          ...
          >
            <button className="mt-4 px-6 py-2.5 bg-gradient-to-r from-yellow-400 to-yellow-500 hover:from-yellow-500 hover:to-yellow-400 text-black font-bold rounded-full shadow-lg transition-transform duration-300 transform hover:scale-105 active:scale-95 relative overflow-hidden group">
      ...
      <div className="w-full hidden md:flex justify-center mt-0 pt-4 z-50 relative">
        <button
          ...
          className="border-2 text-black p-3 px-5 rounded-full shadow-xl hover:bg-yellow-300 hover:text-black transition-all duration-300 animate-bounce transform hover:scale-110 hover:rotate-3"
          style={{
      ...
      <div className="py-20 px-4 flex md:mt-15 justify-center items-center">
        <div className="relative max-w-6xl w-full rounded-xl overflow-hidden border border-gray-300 shadow-xl bg-white opacity-0 translate-y-10 animate-fadeInUp">
          ...
          {/* 🖼️ Image Section */}
          <div className="relative w-full h-[260px] md:h-[320px] overflow-hidden rounded-t-xl opacity-0 scale-95 animate-fadeInScale">
            <img
