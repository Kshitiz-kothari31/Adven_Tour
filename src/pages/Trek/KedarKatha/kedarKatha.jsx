      ...
      <section className="relative w-full h-[90vh] overflow-hidden bg-black font-josefin">
        ...
        <div className="absolute inset-0 flex items-center justify-start px-6 md:px-20 z-40">
          <div className="text-left max-w-3xl animate-fadeInLeft">
            ...
            <button
              className="mt-6 bg-gradient-to-r from-green-400 to-emerald-500 hover:from-emerald-500 hover:to-green-400 text-white font-semibold px-8 py-3 rounded-full shadow-lg transition-all duration-300 text-sm md:text-base flex items-center gap-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50"
        ...
        {/* Wave footer */}
        <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-[0] z-40 animate-fadeInUp">
          <svg
        ...
        <style jsx>{`
          ...
          .animate-heroZoom { animation: heroZoom 12s ease-in-out forwards; }
          @keyframes typing {
            from { width: 0; }
            to { width: 100%; }
          }
          .animate-typing { animation: typing 3.2s steps(32, end) 1 forwards; }
