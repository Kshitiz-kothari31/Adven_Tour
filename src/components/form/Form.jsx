...
export default function Form({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-8 md:py-12 lg:py-16">
      <div className="w-full max-w-6xl relative">
        ...
        <div className="md:flex contain-layout">
          ...
          <div className="md:w-3/5 lg:w-1/2">
            <div className={`${boxClass} rounded-2xl shadow-xl overflow-hidden p-8 md:p-10 lg:p-12 will-change-transform`}>
              <div className="text-center mb-10">
                <h2 className={`text-3xl md:text-4xl font-light tracking-tight mb-4 ${headingClass}`}>
                  Plan Your Adventure
                </h2>
              ...
              >
                  ...
                  {[
                    ...
                    <div key={field.name}>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 rounded-lg border border-gray-300 bg-transparent shadow-sm transition-all duration-200 ${focusClass} ${focusedField === field.name ? 'ring-2 ring-gray-400 border-transparent' : ''}`}
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-lg border border-gray-300 bg-transparent shadow-sm transition-all duration-200 ${focusClass} ${focusedField === 'user_email' ? 'ring-2 ring-gray-400 border-transparent' : ''}`}
                ...
                <div>
                  ...
                  <select
                    ...
                    defaultValue=""
                    required
                    className={`w-full px-4 py-3 rounded-lg border border-gray-300 bg-transparent shadow-sm transition-all duration-200 ${focusClass} ${focusedField === 'interest' ? 'ring-2 ring-gray-400 border-transparent' : ''}`}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full px-4 py-3 rounded-lg border border-gray-300 bg-transparent shadow-sm transition-all duration-200 ${focusClass} ${focusedField === 'message' ? 'ring-2 ring-gray-400 border-transparent' : ''}`}
                ...
                <button
                  ...
                  className={`w-full py-3.5 px-6 rounded-lg font-medium text-white shadow-md transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center ${buttonClass} ${isSubmitting ? 'opacity-75 cursor-not-allowed' : ''}`}
                ...
                {isSubmitted && (
                  <div className="mt-4 p-3 bg-green-100 text-green-700 rounded-lg text-center animate-fadeIn" role="status" aria-live="polite">
