      ...
      <div className="w-full max-w-6xl relative">
        ...
        <div className="md:flex contain-layout">
          ...
          <div className="hidden md:block md:w-2/5 lg:w-1/2 pr-8 lg:pr-12">
            <div className="h-full flex flex-col justify-center">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/10 to-teal-500/10 rounded-3xl transform rotate-3"></div>
          ...
          <div className="md:w-3/5 lg:w-1/2">
            <div className={`${boxClass} rounded-2xl shadow-xl overflow-hidden p-4 sm:p-6 md:p-8 lg:p-12`}>
              <div className="text-center mb-6 sm:mb-8 md:mb-10">
                <h2 className={`text-xl sm:text-2xl md:text-3xl font-light tracking-tight mb-2 sm:mb-4 ${headingClass}`}>
                  Plan Your Adventure
                </h2>
              ...
              >
                ...
                {isSubmitted && (
                  <div className="mt-3 sm:mt-4 p-2 sm:p-3 bg-green-100 text-green-700 rounded-lg text-center text-sm">
              ...
              <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-200 md:hidden">
                <div className="flex flex-col space-y-3 sm:space-y-4 text-gray-600">
                  {[
                    ...
                    <div key={index} className="flex items-center justify-center">
                      <item.icon className="w-3 h-3 sm:w-4 sm:h-4 mr-2" />
